...
+                  <p className="text-gray-700">{contacts.phone.main}</p>
+                  <p className="text-gray-700">{contacts.whatsapp.display}</p>
                 </div>
               </div>
...
+                  <p className="text-gray-700">{contacts.email.main}</p>
+                  <p className="text-gray-700">{contacts.email.reservations}</p>
                 </div>
               </div>
...
+                    {contacts.address.neighborhood} - {contacts.address.city}/{contacts.address.state}<br />
+                    CEP: {contacts.address.zipCode}
                   </p>
                 </div>
               </div>
...
-                    Sábado: 8h às 16h<br />
-                    Domingo: 8h às 12h
+                    {contacts.businessHours.weekdays}<br />
+                    {contacts.businessHours.saturday}<br />
+                    {contacts.businessHours.sunday}
                   </p>
                 </div>
               </div>
             </div>
...
+                </a>
+                <a 
+                  href={`mailto:${contacts.email.main}`}
+                  className="bg-black hover:bg-gray-800 text-yellow-400 p-3 rounded-full transition-colors"
+                >
